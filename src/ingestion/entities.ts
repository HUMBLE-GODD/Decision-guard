 ...
 *     Set DECISIONGUARD_LLM_ENTITIES=true to enable (costs ~0.001 per ingest).
 *
...
const USE_LLM_ENTITIES = process.env.DECISIONGUARD_LLM_ENTITIES === "true";
 ...
 * LLM mode if DECISIONGUARD_LLM_ENTITIES=true.
 */
