/**
 * DECISIONGUARD Benchmark Client
 *
 * Interfaces with DECISIONGUARD's search, recall, and ingest APIs for benchmark evaluation.
...
/**
 * Ingest a conversation session into DECISIONGUARD.
...
/**
 * Search DECISIONGUARD and return ranked results.
