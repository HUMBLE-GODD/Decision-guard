/**
 * LongMemEval Benchmark Runner for DECISIONGUARD
 *
 * Evaluates DECISIONGUARD's memory retrieval on the LongMemEval benchmark:
 ...
 *
 * Methodology:
 *   1. For each question, ingest all haystack sessions into DECISIONGUARD as separate memories
 *   2. Search DECISIONGUARD with the question text
 ...
 * Raw DECISIONGUARD retrieval performance with honest scoring.
 *
...
import {
  ...
  ingestSession,
  search,
} from "../lib/decisionguard-client.js";
import {
  type QuestionResult,
  findRank,
  scoreBenchmark,
...
async function main() {
  console.log("============================================");
  console.log("  DECISIONGUARD V2.4 -- LongMemEval Benchmark");
  console.log("============================================");
