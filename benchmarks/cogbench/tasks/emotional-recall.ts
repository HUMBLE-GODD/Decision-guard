...
const EMOTIONAL_PAIRS: EmotionalPair[] = [
  ...
  },
  {
    domain: "hire",
    topic: "key hire",
    emotional: "Thrilled to announce we finally landed Dr. Maya Patel as our Head of AI! She turned down offers from Google DeepMind and OpenAI to join us. Her paper on cognitive architectures has 2,400 citations. I'm incredibly excited — this is the hire that makes DECISIONGUARD real.",
