/**
 * LoCoMo Benchmark Runner for DECISIONGUARD
 *
 * Evaluates DECISIONGUARD on the LoCoMo benchmark (ACL 2024):
 * 10 long conversations, 1,986 QA pairs across 5 categories.
 *
 * Methodology:
 *   1. Ingest all sessions for each conversation into DECISIONGUARD
...
async function main() {
  console.log("============================================");
  console.log("  DECISIONGUARD V2.4 -- LoCoMo Benchmark");
  console.log("============================================");
