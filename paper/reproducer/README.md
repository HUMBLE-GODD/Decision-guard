# DECISIONGUARD v2.4 Benchmark Reproducer

Scripts that reproduce every number reported in
[`paper/drafts/decisionguard-v2-4-technical-note.md`](../drafts/decisionguard-v2-4-technical-note.md).
...
- Embedding responses are **not** cached by default; benchmarks
  ...
  honestly. Set `DECISIONGUARD_EMBED_CACHE=1` to enable local caching for
